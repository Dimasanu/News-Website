                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <div class="small mb-3 text-muted">Enter your email address and new password to reset your password.</div>
                                        <form method="POST" action="{{ route('password.reset.post') }}">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputPasswordConfirmation" name="password_confirmation" type="password" placeholder="Confirm New Password" required />
