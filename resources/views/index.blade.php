            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    ...
                    <div class="post-entry-1 md d-flex align-items-center mb-4 w-100">
                        <div class="text">
                            <div class="post-meta"><span class="date">{{$post['category']}}</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            <h2><a href="/single-post">11 Work From Home Part-Time Jobs You Can Do Now</a></h2>
                            <p class="mb-4 d-block">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vero temporibus repudiandae, inventore pariatur numquam cumque possimus exercitationem?</p>
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="d-lg-flex post-entry-2">
                        ...
                        <div>
                            ...
                            <h3><a href="/single-post">What is the son of Football Coach John Gruden, Deuce Gruden
                                    doing Now?</a></h3>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="post-entry-1 border-bottom">
                                ...
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="/single-post">11 Work From Home Part-Time Jobs You Can Do
                                        Now</a></h2>
                            ...
                            <div class="post-entry-1">
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="/single-post">5 Great Startup Tips for Female Founders</a>
                                </h2>
                                <span class="author mb-3 d-block">Jenny Wilson</span>
                            </div>
                        </div>
                        <div class="col-lg-8">
                            <div class="post-entry-1">
                                ...
                                <div class="post-meta"><span class="date">Culture</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="/single-post">How to Avoid Distraction and Stay Focused
                ...
                <div class="col-md-3">
                    ...
                    <div class="post-entry-1 border-bottom">
                        <div class="post-meta"><span class="date">Culture</span> <span
                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                        <h2 class="mb-2"><a href="/single-post">9 Half-up/half-down Hairstyles for Long and Medium
                                Hair</a></h2>
                        <span class="author mb-3 d-block">Jenny Wilson</span>
                    </div>
                    ...
                    <div class="post-entry-1 border-bottom">
                        <div class="post-meta"><span class="date">Culture</span> <span
                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                        <h2 class="mb-2"><a href="/single-post">The Best Homemade Masks for Face (keep the Pimples
                                Away)</a></h2>
                        <span class="author mb-3 d-block">Jenny Wilson</span>
                    </div>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-4 border-start custom-border">
                            ...
                            <div class="post-entry-1">
                                ...
                                <h2><a href="/single-post">How to Avoid Distraction and Stay Focused During Video
                                        Calls?</a></h2>
                            </div>
                            <div class="post-entry-1">
                                ...
                                <h2><a href="/single-post">Why Craigslist Tampa Is One of The Most Interesting Places
                                        On the Web?</a></h2>
                            </div>
                        </div>
                        <div class="col-lg-4 border-start custom-border">
                            <div class="post-entry-1">
                                ...
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2><a href="/single-post">6 Easy Steps To Create Your Own Cute Merch For Instagram</a>
                                </h2>
                            </div>
                            <div class="post-entry-1">
                                <a href="/single-post"><img src="assets/img/post-landscape-2.jpg" alt=""
                                ...
                                <h2><a href="/single-post">10 Life-Changing Hacks Every Working Mom Should Know</a>
                                </h2>
                            </div>
                            <div class="post-entry-1">
                                <a href="/single-post"><img src="assets/img/post-landscape-1.jpg" alt=""
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="post-entry-1 border-bottom">
                                <div class="post-meta"><span class="date">Lifestyle</span> <span
                                        class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2 class="mb-2"><a href="/single-post">17 Pictures of Medium Length Hair in Layers
